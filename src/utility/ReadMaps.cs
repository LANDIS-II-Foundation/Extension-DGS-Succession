...
namespace Landis.Extension.Succession.DGS
{
    ...
    public static class ReadMaps
    {
                ...
                foreach (Site site in PlugIn.ModelCore.Landscape.AllSites)
                {
                    ...
                    if (site.IsActive)
                    {
                        if (mapValue < 0.0001 || mapValue > 0.75)
                            throw new InputValueException(mapValue.ToString(),
                                                          "Soil field capacity value {0} is not between {1:0.00000} and {2:0.00}. Site_Row={3:0}, Site_Column={4:0}",
                ...
                foreach (Site site in PlugIn.ModelCore.Landscape.AllSites)
                {
                    ...
                    if (site.IsActive)
                    {
                        ...
                        if (mapValue > SiteVars.SoilFieldCapacity[site])
                            throw new InputValueException(mapValue.ToString(),
                                                          "Wilting Point {0.0} is greater than field capacity {1:0.00}.  Site_Row={3:0}, Site_Column={4:0}",
        ...
        public static void ReadSoilCNMaps(string pathSOC, string pathSON)
        {
                ...
                foreach (Site site in PlugIn.ModelCore.Landscape.AllSites)
                {
                    ...
                    if (site.IsActive)
                    {
                        if (mapValue <= 1.0 || mapValue > 100000.0)
                            throw new InputValueException(mapValue.ToString(),
                                                          "SOC value {0} is not between {1:0.0} and {2:0.0} in O Horizon. Site_Row={3:0}, Site_Column={4:0}",
                ...
                foreach (Site site in PlugIn.ModelCore.Landscape.AllSites)
                {
                    ...
                    if (site.IsActive)
                    {
                        if (mapValue <= 0.0 || mapValue > 50000.0)
                            throw new InputValueException(mapValue.ToString(),
                                                          "SON value {0} is not between {1:0.0} and {2:0.0} in O Horizon. Site_Row={3:0}, Site_Column={4:0}",
            ...
            //            if (mapValue <= 1.0 || mapValue > 100000.0)
            //                throw new InputValueException(mapValue.ToString(),
            //                                              "SOC value {0} is not between {1:0.0} and {2:0.0} in Mineral Horizon. Site_Row={3:0}, Site_Column={4:0}",
            //                                              mapValue, 1.0, 100000.0, site.Location.Row, site.Location.Column);
            //            SiteVars.SoilPrimary[site].Carbon = mapValue;
            //        }
            //    }
            ...
            //            if (mapValue <= 0.0 || mapValue > 50000.0)
            //                throw new InputValueException(mapValue.ToString(),
            //                                              "SON value {0} is not between {1:0.0} and {2:0.0} in Mineral Horizon. Site_Row={3:0}, Site_Column={4:0}",
            //                                              mapValue, 0.0, 50000.0, site.Location.Row, site.Location.Column);
            //            SiteVars.SoilPrimary[site].Nitrogen = mapValue;
            //        }
            //    }
            ...
            using (map)
            {
                ...
                foreach (Site site in PlugIn.ModelCore.Landscape.AllSites)
                {
                    ...
                    if (site.IsActive)
                    {
                        if (mapValue < 0.0 || mapValue > 50000.0)
                            throw new InputValueException(mapValue.ToString(),
                                                          "SurfDeadWood (CWD) value {0} is not between {1:0.0} and {2:0.0}. Site_Row={3:0}, Site_Column={4:0}",
                                                          mapValue, 0.0, 50000.0, site.Location.Row, site.Location.Column);
                        ...
                        SiteVars.SoilStructural[site].Carbon = SiteVars.SurfaceDeadWood[site].Carbon * 0.85;
                        ...
                        SiteVars.SoilMetabolic[site].Carbon = SiteVars.SurfaceDeadWood[site].Carbon * 0.15;
            ...
            using (map)
            {
                ...
                foreach (Site site in PlugIn.ModelCore.Landscape.AllSites)
                {
                    ...
                    if (site.IsActive)
                    {
                        if (mapValue < 0.0 || mapValue > 50000.0)
                            throw new InputValueException(mapValue.ToString(),
                                                          "SoilDeadWood (Dead coarse roots) value {0} is not between {1:0.0} and {2:0.0}. Site_Row={3:0}, Site_Column={4:0}",
                                                          mapValue, 0.0, 50000.0, site.Location.Row, site.Location.Column);
