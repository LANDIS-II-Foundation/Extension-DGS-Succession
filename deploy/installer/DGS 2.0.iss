...
#define ExtensionName "DGS Succession"
...
AppId={{ECA1B208-5E02-4D32-BB6E-48C5D96D65A9}
...
Source: {#BuildDir}\Landis.Extension.Succession.DGS-v2.dll; DestDir: {#ExtDir}; Flags: replacesameversion
...
Source: {#BuildDir}\Landis.Library.InitialCommunity.Universal-v2.dll; DestDir: {#ExtDir}; Flags: uninsneveruninstall replacesameversion
...
Source: {#BuildDir}\Landis.Library.Succession-v10.dll; DestDir: {#ExtDir}; Flags: uninsneveruninstall replacesameversion
...
;Source: ..\examples\SingleCellRasters\*.tif; DestDir: {#AppDir}\examples\{#ExtensionName}; Flags: replacesameversion
...
;Source: ..\examples\SHAW\*.csv; DestDir: {#AppDir}\examples\{#ExtensionName}; Flags: replacesameversion
;Source: ..\examples\SHAW\*.txt; DestDir: {#AppDir}\examples\{#ExtensionName}; Flags: replacesameversion
;Source: ..\examples\GIPL\*.txt; DestDir: {#AppDir}\examples\{#ExtensionName}; Flags: replacesameversion
...
[Run]
Filename: {#ExtensionsCmd}; Parameters: "remove ""DGS Succession"" "; WorkingDir: {#LandisPlugInDir}
